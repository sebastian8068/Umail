...
class WindowRead(customtkinter.CTkToplevel):
    ...
    def setBody(self, body: str) -> None:
           # Cambia a modo normal para editar
        self.texbox_body.configure(state="normal")
    ...
    def setSenderTlf(self, tlf: str) -> None:
        self.output_sender_tlf.configure(text=tlf)
